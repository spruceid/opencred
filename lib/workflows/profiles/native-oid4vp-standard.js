...
export async function handleAuthorizationResponse({
  ...
  // An OAuth/OID4VP error is a terminal response, not a presentation. Handle
  // it before attempting to decrypt or extract a vp_token. In particular, a
  // user denial is sent as `error=access_denied` with no vp_token.
